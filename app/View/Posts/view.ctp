	...
	<dl>
		...
		<div class="form-row">
			<div class="form-group col-md-6">
				<dt>
					<h6> <strong> Data de criação:</strong><?php echo h($this->Time->format('F jS, Y h:i A', $post['Post']['created'])); ?></h6>
				</dt>

			</div>
			<div class="form-group col-md-6">
				<dt>
					<h6> <strong> Usuario criador:</strong><?php echo $this->Html->link($post['Users']['name'], array('controller' => 'users', 'action' => 'view', $post['Users']['id'])); ?></h6>
				</dt>
				<dd>
					<h6></h6>
					&nbsp;
